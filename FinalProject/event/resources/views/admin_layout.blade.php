			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all-service')}}"><i class="icon-envelope"></i><span class="hidden-tablet">All Service</span></a></li>
						<li><a href="{{URL::to('/add-service')}}"><i class="icon-tasks"></i><span class="hidden-tablet">Add Service</span></a></li>
						
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Vendors</span><span class="label label-important"> Service </span></a>
							<ul>
								<li><a class="submenu" href="{{URL::to('/add-vendor')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Vendor</span></a></li>
								<li><a class="submenu" href="{{URL::to('/all-vendor')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Vendor</span></a></li>
							</ul>	
						</li>
						...
						<li><a href="typography.html"><i class="icon-font"></i><span class="hidden-tablet"> Side Name</span></a></li>
						<li><a href="gallery.html"><i class="icon-picture"></i><span class="hidden-tablet"> Gallery</span></a></li>
						<li><a href="table.html"><i class="icon-align-justify"></i><span class="hidden-tablet"> Aboute Us</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
